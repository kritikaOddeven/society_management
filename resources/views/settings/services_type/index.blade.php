    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Service Type</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-md-flex justify-content-between">
                            ...
                            <div>
                                <button class="btn btn-primary rounded" data-toggle="modal" data-target="#addSTypeModal"><i class="fas fa-plus"></i> Add Service Type</button>
                            </div>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
