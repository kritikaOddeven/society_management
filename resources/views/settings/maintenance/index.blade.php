                                        ...
                                        <table class="table table-striped" id="table-1">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Unit Value (Annualy)</th>
                                                    <th>Unit Value (Half yearly)</th>
                                                    <th>Unit Value (Quaterly)</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td> 1 BHK</td>
                                                    <td> 
                                                        <input type="text" class="form-control @error('unit_value') is-invalid @enderror" id="unit_value" name="unit_value" value="{{ old('unit_value') }}">
                                                    </td>
                                                    <td> 
                                                        <input type="text" class="form-control @error('unit_value') is-invalid @enderror" id="unit_value" name="unit_value" value="{{ old('unit_value') }}">
                                                    </td>
