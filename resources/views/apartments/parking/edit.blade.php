<div class="modal fade" tabindex="-1" role="dialog" id="editParkingModal{{ $parking->id }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('parkings/' . $parking->id) }}" data-role-id="{{ $parking->id }}" method="POST">
                @method('PUT')
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('parking_code') is-invalid @enderror" id="parking_code" name="parking_code" value="{{ $parking->parking_code }}" required>
                                @error('parking_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
