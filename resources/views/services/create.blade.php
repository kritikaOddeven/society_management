    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('owners.index') }}">Services</a></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('service_id') is-invalid @enderror" id="service_id" name="service_id">
                                                ...
                                                @foreach ($types as $type)
                                                    <option value="{{ $type->id }}" {{ old('service_id') == $type->id ? 'selected' : '' }}>
                                                        {{ ucfirst(str_replace('-', ' ', $type->service_type)) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck1">Is he/she will be a daily help?</label>
                                            </div>
                                        </div>
                                    </div>
