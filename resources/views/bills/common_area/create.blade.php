                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Add Common Area Bill</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('bills.common_area.store') }}" method="POST" enctype="multipart/form-data" id="addCommonAreaBillForm">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('bill_type_id') is-invalid @enderror" id="bill_type_id" name="bill_type_id">
                                                ...
                                                @foreach ($billTypes as $billType)
                                                    <option value="{{ $billType->id }}" {{ old('bill_type_id') == $billType->id ? 'selected' : '' }}>
                                                        {{ $billType->bill_type }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('bill_amount') is-invalid @enderror" id="bill_amount" name="bill_amount" value="{{ old('bill_amount') }}" placeholder="Enter amount">
                                            @error('bill_amount')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
